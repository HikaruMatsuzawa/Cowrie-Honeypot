...
- [Lightsail初回セットアップ手順](docs/lightsail-setup.md)
...
まっさらなLightsailへSSHログインした直後から進める場合は、まず [Lightsail初回セットアップ手順](docs/lightsail-setup.md) を確認してください。運用全体の整理は [運用手順](docs/operations.md) にあります。
