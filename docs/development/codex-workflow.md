...
- 作業前に `README.md`、`AGENTS.md`、`docs/README.md`、関連する仕様書を読む。
...
参照する仕様書: `README.md`, `AGENTS.md`, `docs/development/project-brief.md`
...
参照する仕様書: `docs/development/requirements.md`, `docs/development/test-plan.md`, `docs/development/security.md`
...
参照する仕様書: `docs/development/architecture.md`, `docs/development/security.md`, `docs/deployment/operations.md`
...
参照する仕様書: `docs/development/requirements.md`, `docs/development/security.md`, `docs/deployment/operations.md`
...
参照する仕様書: `docs/development/requirements.md`, `docs/development/test-plan.md`
...
参照する仕様書: `docs/development/requirements.md`, `docs/development/security.md`, `docs/development/test-plan.md`
...
参照する仕様書: `docs/development/requirements.md`, `docs/development/security.md`
...
参照する仕様書: `docs/development/test-plan.md`, `docs/development/architecture.md`, `docs/development/security.md`, `docs/deployment/operations.md`
...
参照する仕様書: `docs/development/project-brief.md`, `docs/development/requirements.md`, `docs/development/architecture.md`, `docs/development/security.md`, `docs/development/test-plan.md`, `docs/deployment/operations.md`, `docs/deployment/lightsail-setup.md`
...
人間が確認するポイント: `docs/deployment/lightsail-setup.md` が初回SSHログイン後から迷わず進められるか、管理用OpenSSH移動、Lightsailファイアウォール、静的IP、IPv6、料金、停止手順、復旧手順が明確か。
...
```text
Step 14「実送信元IP保持対応」を実施してください。まずテスト計画と設計差分を確認し、`cowrie-ssh-proxy` を使わずCowrieコンテナ自身をホスト側TCP 22番へ直接公開する構成へ変更してください。Dockerネットワークは固定サブネット化し、Cowrieコンテナから外部への新規通信はiptablesの `DOCKER-USER` chainで遮断できるようにしてください。ローカルではインターネットへ公開せず `127.0.0.1:2222` のみで確認できる状態を維持してください。AWSリソースやLightsail設定はCodexから変更せず、人間が実行する手順だけを文書化してください。
```
...
実行するテストまたは確認コマンド: `docker compose config`, `docker compose --env-file .env.lightsail.example config`, `pytest`, `ruff check .`, `mypy src`, ローカルSSH接続確認、`scripts/cowrie_egress_firewall.sh` の構文確認、外向き通信確認、公開NG文字列の検索
