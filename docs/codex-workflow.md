...
参照する仕様書: `docs/project-brief.md`, `docs/requirements.md`, `docs/architecture.md`, `docs/security.md`, `docs/test-plan.md`, `docs/operations.md`
...
人間が確認するポイント: 管理用OpenSSH移動、Lightsailファイアウォール、静的IP、IPv6、料金、停止手順、復旧手順が明確か。
